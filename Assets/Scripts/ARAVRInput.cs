...
{
#if PC
    public enum ButtonTarget  //ButtonTarget 안에 이 4가지 요소가 저장되어있음
    {
        Fire1,  //왼쪽
        Fire2,  //오른쪽
        Fire3,  //가운데
...
#endif
#if Oculus
    static Transform GetTransform()  //어떤 용어든 Get이 앞에 붙으면 어떠한 정보를 가져온다는 의미(반대되는 Set은 이 값을 넣고 싶을 때 사용)
    {
...
# endif
    ...
    // ���� ��ϵ� ���� ��Ʈ�ѷ��� ã�� ��ȯ
    public static Transform LHand  //위의 코드와 public의 차이 -> 혹시나 외부에서 공유하는 코드가 오류생길 때 static Transform lHand;로도 적어둠둠
    {
        get
        {
            if (lHand == null)
    ...
    // ������ ��Ʈ�ѷ�
    static Transform rHand; //얘가 진짜 느낌낌
    // ���� ��ϵ� ������ ��Ʈ�ѷ� ã�� ��ȯ
    public static Transform RHand //얘는 외부에서 공유하는 대체 느낌낌
    {
        get
        {
            // ���� rHand�� ���� �������
    ...
    public static Vector3 RHandDirection
    {
        ...
        {
#if PC
            Vector3 direction = RHandPosition - Camera.main.transform.position;  //벡터의 수식 원리인데...엉...
